...
const AvisoLegalText = () => {
  return (
    <>
      <p>En esta web se respetan y cuidan los datos personales de los usuarios. Como usuario debes saber que tus derechos están garantizados. Me he esforzado en crear un espacio seguro y confiable.</p>

      <h3>Tu privacidad es importante para mí.</h3>
      <p>
        En esta declaración de privacidad te explico qué datos personales recopilo de mis usuarios y cómo los utilizo. Te animo a leer detenidamente estos términos antes de facilitar tus datos personales en esta web.<br />
        El simple acceso a este sitio web no supone entablar ningún tipo de relación comercial entre el profesional de la salud y el usuario. <br />
        En el caso de los menores de quince años se requiere el consentimiento de los padres o tutores para el tratamiento de sus datos personales.<br />
        En ningún caso se recabarán del menor de edad datos relativos a la situación profesional, económica o a la intimidad de los otros miembros de la familia, sin el consentimiento de éstos.<br />
        El acceso y la navegación en este sitio web supone aceptar y conocer las advertencias legales, condiciones y términos de uso contenidas en ella.<br />
        El titular del sitio web puede ofrecer servicios o productos que podrán encontrarse sometidos a unas condiciones particulares propias que, según los casos, sustituyan, completen y/o modifiquen las presentes condiciones, y sobre las cuales se informará al usuario en cada caso concreto.<br />
        Si eres menor de quince años y has accedido a este sitio web sin avisar a tus padres no debes registrarte como usuario.<br />
        En esta web se respetan y cuidan los datos personales de los usuarios. Como usuario debes saber que tus derechos están garantizados.<br />
        Me he esforzado en crear un espacio seguro y confiable y por eso quiero compartir mis principios respecto a tu privacidad:
      </p>
      <ul>
      ...
      <p>
        ...
        Esta web está adecuada a las exigencias de la Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal (LOPD), y al Real Decreto 1720/2007, de 21 de diciembre, conocido como el Reglamento de desarrollo de la LOPD. Cumple también con el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo de 27 de abril de 2016 relativo a la protección de las personas físicas (RGPD), así como con la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y Comercio Electrónico (LSSICE o LSSI).
      </p>
      ...
      <ul>
        ...
        <li><strong>Número de cédula profesional:</strong> 12684271</li>
      ...
      <p>
        A efectos de lo previsto en el Reglamento General de Protección de Datos antes citado, los datos personales que me envíes a través de los formularios de la web, recibirán el tratamiento de datos de “Usuarios de la web y suscriptores”.<br />
      ...
      <ul>
        ...
        <li><strong>Principio de limitación del plazo de conservación:</strong> Plazos o criterios de conservación de los datos: <br />
      Los datos personales proporcionados se conservarán, mientras se mantenga la relación terapéutica, no se solicite su supresión por el interesado, o durante 1 año a partir de la última confirmación de interés. </li>
        <li><strong>Decisiones:</strong> Decisiones automatizadas, perfiles y lógica aplicada: La empresa NO tomará decisiones automatizadas.</li>
      ...
      <p>Los datos personales que trato en Ayudaleyprotecciondatos.es proceden de:</p>
      <ul>
        <li>Formulario de contacto.</li>
        <li>Solicitud de presupuestos a través del directorio. </li>
      ...
      <p>Cuando un usuario se conecta con esta web por ejemplo para comentar un post, solicitar presupuesto o contactar, está facilitando información de carácter personal. Esa información puede incluir datos de carácter personal como pueden ser tu dirección IP, nombre o nombre de usuario, dirección de correo electrónico, otros datos suministrados en un mensaje o archivos adjuntos. Al facilitar esta información, el usuario da su consentimiento para que su información sea recopilada, utilizada, gestionada y almacenada, sólo como se describe en la presente Política de Privacidad.<br />
      Existen otras finalidades por la que trato tus datos personales: </p>
      <ul>
        ...
        <li>Esto puede tener presencia en redes sociales. En ningún caso utilizaré los perfiles de seguidores en redes sociales para enviar publicidad de manera individual. </li>
      </ul>
  </>
  )
} 
