    ...
    <div className='online-therapy-container'>
      ...
      <div className='online-therapy-text-img-container'>
        <div className='online-therapy-text'>
          <a href={arrow1 === arrowOpen ? '#online-heading' : 'javascript:void(0);'}><h3 id='online-q-1' className='h3-open no-select' onClick={handleSelection}>{arrow1} ¿Qué es la terapia Online?</h3></a>
          ...
          <a href={arrow2 === arrowOpen ? '#online-q-1' : 'javascript:void(0);'}><h3 id='online-q-2' className='h3-closed no-select' onClick={handleSelection}>{arrow2} ¿Cuándo acudir a terapia Online?</h3></a>
          <div className='therapy-answer-container'>
          ...
          <a href={arrow3 === arrowOpen ? '#online-q-2' : 'javascript:void(0);'}><h3 id='online-q-3' className='h3-closed no-select' onClick={handleSelection}>{arrow3} ¿Cuál es la duración de la sesión?</h3></a>
          <div className='therapy-answer-container'>
          ...
          <a href={arrow4 === arrowOpen ? '#online-q-3' : 'javascript:void(0);'}><h3 id='online-q-4' className='h3-closed no-select' onClick={handleSelection}>{arrow4} ¿Qué pasos sigo para comenzar?</h3></a>
          <div className='therapy-answer-container'>
